...
def customize_TRK_v7_1(process):
	...
	process.highPtTripletStepTrackingRegions = cms.EDProducer( "GlobalTrackingRegionWithVerticesEDProducer",
	    RegionPSet = cms.PSet( 
	      ...
	      VertexCollection = cms.InputTag( "pixelVertices" ), # trimmedPixelVertices
	      beamSpot = cms.InputTag( "offlineBeamSpot" ),
	...
	process.MC_Tracking_v7 = cms.Path(
	    process.itLocalReco +
